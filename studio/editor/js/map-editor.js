        ...
        function makeMapTreeItem(map, idx) {
            ...
            mapItem.ondblclick = event => {
                ...
                // broad OS double-click interval for a navigation tree. Two
                // close clicks on the same item are required.
        ...
        // docs/design/runtime/rendering/raycaster-tileset-lighting.md and engine/main.lua's
        ...
        function saveMapProperties() {
            ...
            if (document.getElementById('prop-map-fog-enabled').checked && fogPresetId) {
                // Shared preset reference (docs/design/runtime/rendering/fog-presets-and-panorama.md)
