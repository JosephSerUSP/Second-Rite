...
// #521/#809: semantic EditorSurface identity/policy belongs above any one hosting
...
// first-class surfaces ARE, their multiplicity/hosting policy, and whether a
// secondary editor may coexist interactively with the main workspace without
// making BrowserWindow the definition of a surface.
const SURFACES = Object.freeze({
    main: Object.freeze({
        ...
        interactionPolicy: 'workspace-root',
    ...
    tileset: Object.freeze({
        ...
        productionHost: 'native',
        browserTestHost: 'dom-modal',
        // #547 deliberately tests Map-contextual Tileset authoring. Keep this
        // surface concurrent until that authoring experiment resolves rather
        // than deciding its UX through native-window plumbing.
        interactionPolicy: 'concurrent',
...
const EXCLUSIVE_NATIVE_SURFACE_IDS = Object.freeze(
    SECONDARY_NATIVE_SURFACE_IDS.filter(id => SURFACES[id].interactionPolicy === 'exclusive')
);
