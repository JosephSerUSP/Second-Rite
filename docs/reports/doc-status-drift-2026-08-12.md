...
This is point-in-time audit evidence and not a living repository-status source.
...
The following files were scanned at the audited revision and no non-exempt status drift findings were identified:
