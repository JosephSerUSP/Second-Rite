...
-- Tileset atlas configuration. See docs/design/runtime/raycaster-tileset-lighting.md.
...
-- preset reference or inline fields. See docs/design/runtime/fog-presets-and-panorama.md.
...
-- docs/design/runtime/fog-presets-and-panorama.md.
...
-- without being authored in map data (docs/design/runtime/raycaster-tileset-lighting.md).
...
-- docs/design/runtime/raycaster-tileset-lighting.md). Absent light data (older/
