...
- [`docs/design/image-authored-geometry.md`](../design/runtime/image-authored-geometry.md): design intent for height-field and geometry asset authoring.
- [`docs/design/renderer-3d-roadmap.md`](../design/runtime/renderer-3d-roadmap.md): renderer constraints and model/tileset direction.
