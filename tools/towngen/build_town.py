...
SCREENS = {
    ...
    "market": dict(
        ...
        screen_y=136, music="town1",
        npcs=[("auctioneer", "Auctioneer", "npc_auctioneer", 120),
              ("yukio", "Yukio", "npc_yukio", 250),
              ("euler", "Euler", "npc_euler", 430),
    ...
    "quay": dict(
        ...
        screen_y=136, music="town1",
        npcs=[("sign", "Sign", None, 110),
              ("fisherman", None, "npc_fisherman", 380)],
        doors=[
    ...
    "weaponsmith": dict(
        ...
        doors=[("exit_door", "Out to Market Row", 18, "smith_door", 95, None)],
    ),
    "pub": dict(
        ...
        screen_y=136, music="town1",
        npcs=[("owner", "Pub Owner", "npc_pub_owner", 280)],
    ...
    "chapel": dict(
        ...
        screen_y=136, music="town1",
        npcs=[("agnes", "EV012", "npc_agnes", 250)],
        doors=[("exit_door", "Out to the Praca", 17, "chapel_door", 78, None)],
    ),
    "house_laura": dict(
        ...
        doors=[("exit_door", "Out to the Praca", 17, "laura_door", 58, None)],
    ),
    "house_alicia": dict(
        ...
        screen_y=136, music="town1",
        npcs=[("alicia", "Alicia", "npc_alicia", 300)],
