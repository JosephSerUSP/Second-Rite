...
MATERIALS = ["old_limestone","rough_limestone","ritual_gold","oxidized_bronze","wrought_iron","dark_wood","aged_cloth","smoked_glass","wet_residue","bone","wax","crystal","whitewash","azulejo","terracotta","bread_crust","forge_scale","charcoal","foliage"]
